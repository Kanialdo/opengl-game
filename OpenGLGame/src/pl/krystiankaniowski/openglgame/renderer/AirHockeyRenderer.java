...
public class AirHockeyRenderer implements Renderer {
	...
	public void onSurfaceChanged(GL10 arg0, int width, int height) {
		...
		// final float aspectRatio = width > height ? (float) width / (float)
		// height : (float) height / (float) width;
		// if (width > height) {
		// // Landscape
		// orthoM(projectionMatrix, 0, -aspectRatio, aspectRatio, -1f, 1f, -1f,
		// 1f);
		// } else {
		// // Portrait or square
		// orthoM(projectionMatrix, 0, -1f, 1f, -aspectRatio, aspectRatio, -1f,
		// 1f);
		// }
